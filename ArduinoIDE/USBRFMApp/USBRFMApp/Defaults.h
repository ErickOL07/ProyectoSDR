...
const uint8_t DEFAULTS[] PROGMEM = {
  ...
  CDS::BINARY | 1, 0x04, 0x00, 0x00, 0x25, 0x80,
  CDS::BINARY | 1, 0x06, 'c','o','n','f','i','g',
  CDS::BINARY | 1, 0x01, 0x03,
  CDS::BINARY | 1, 0x06, 'i','n','v','e','r','t',
  CDS::BINARY | 1, 0x01, 0x00,
  CDS::BINARY | 1, 0x05, 'b','s','i','z','e',
  CDS::BINARY | 1, 0x01, 0x80,
  CDS::BINARY | 1, 0x02, 'r','x',
  CDS::BINARY | 1, 0x01, 0x7F,
  CDS::BINARY | 1, 0x02, 't','x',
  CDS::BINARY | 1, 0x01, 0x7F,
  CDS::BINARY | 1, 0x03, 'r','f','m',
  CDS::OBJECT | 1, 0x0A,
  CDS::BINARY | 1, 0x04, 'f','r','e','q',
  CDS::BINARY | 1, 0x04, 0x36, 0xB2, 0x10, 0xC0, // 915E6 in hexadecimal (0x36B210C0)
